...
Event.where(name: "Bike Ride").first_or_create(club_id: "5", date:"2021/04/20", comment: "Bring your own bike")
Event.where(name: "Walk").first_or_create(club_id: "3", date:"2021/05/01", comment: "A 4 mile walk")
Event.where(name: "Swimming Trip").first_or_create(club_id: "4", date:"2021/05/12", comment: "A trip to a local swimming pool")
